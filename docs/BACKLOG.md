...
- [ ] **1.1 Wow moment: dragging bet size live-redraws the fan and the ruin counter**
...
- [ ] **1.2 Edge and win-rate controls drive the simulation**
...
- [ ] **1.3 Adjustable path count and bets-per-path**
...
- [ ] **1.4 Fan chart renders crisply on canvas at any size**
...
- [ ] **2.1 Kelly-optimal fraction is computed and displayed**
...
- [ ] **2.2 "Snap to Kelly" toggle sets bet size to the Kelly fraction**
...
- [ ] **2.3 Side-by-side ruin comparison: manual sizing vs Kelly sizing**
...
- [ ] **3.1 Percentile bands overlay the raw path fan**
...
- [ ] **3.2 Shareable state via URL query parameters**
...
- [ ] **3.3 Design polish pass matches docs/DESIGN.md at desktop and phone widths**
...
- [ ] **3.4 Reduced motion and accessibility pass**
...
- [ ] **4.1 Input validation for edge-case slider values**
...
- [ ] **4.2 Static deploy readiness under a subpath**
