...
export function parseStateFromQuery(search) {
  ...
  return {
    ...
    payoutRatio: clampNumber(parseFloat(params.get("payout")), 0.1, 10, DEFAULT_STATE.payoutRatio),
    ...
    numBets: clampNumber(parseFloat(params.get("bets")), 0, 1000, DEFAULT_STATE.numBets),
